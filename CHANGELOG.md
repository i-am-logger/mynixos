...
## [0.26.1](https://github.com/i-am-logger/mynixos/compare/mynixos-v0.26.0...mynixos-v0.26.1) (2026-09-26)


### Bug Fixes

* **deps:** pin vogix to v0.12.2 ([751a8c1](https://github.com/i-am-logger/mynixos/commit/751a8c135c176f380df24b0227e05da4c5531514))
...
* **legion-16irx8h:** gate GRUB on !secureBoot so lanzaboote can take over ([#169](https://github.com/i-am-logger/mynixos/issues/169)) ([2e75a9b](https://github.com/i-am-logger/mynixos/commit/2e75a9b2a23ba3724ed0e38b29bc098e6b95a91c))
...
* **graphical:** the desktop is the vogix shell — waybar, mako, hyprlock, walker and the old login deleted ([#163](https://github.com/i-am-logger/mynixos/issues/163))

### Features

* **graphical:** the desktop is the vogix shell — waybar, mako, hyprlock, walker and the old login deleted ([#163](https://github.com/i-am-logger/mynixos/issues/163)) ([0a28dbf](https://github.com/i-am-logger/mynixos/commit/0a28dbfdc04d385b05cd197283cf97d268d65162))
...
* **system:** rebuild-system update, and stop shipping an update that cannot run ([e050fdb](https://github.com/i-am-logger/mynixos/commit/e050fdb29967a6031507cfdf1415e6642dc4b03d))
...
* **deps:** flake update — nixpkgs 2026-08-13 + vogix concurrent-spawn test fixes ([#149](https://github.com/i-am-logger/mynixos/issues/149)) ([488fa2c](https://github.com/i-am-logger/mynixos/commit/488fa2cae8d165330a991f65dad6a0c94668dea4))
...
* **deps:** vogix 0.8.3 ([#145](https://github.com/i-am-logger/mynixos/issues/145)) ([8f00119](https://github.com/i-am-logger/mynixos/commit/8f0011966f6839effca77830de5023ac572e9ccf))

## [0.17.0](https://github.com/i-am-logger/mynixos/compare/mynixos-v0.16.0...mynixos-v0.17.0) (2026-08-10)


### Features

* Apple/Sipeed peripherals, RustDesk and qobine apps ([#143](https://github.com/i-am-logger/mynixos/issues/143)) ([1ec4a4e](https://github.com/i-am-logger/mynixos/commit/1ec4a4edece743b80ab88f939775933fb824c96e))

## [0.16.0](https://github.com/i-am-logger/mynixos/compare/mynixos-v0.15.1...mynixos-v0.16.0) (2026-08-10)


### Features

* **apps:** herdr as the default multiplexer, discord per platform ([#141](https://github.com/i-am-logger/mynixos/issues/141)) ([912a0e3](https://github.com/i-am-logger/mynixos/commit/912a0e346e9ce798bba27634ac84a76dee3ffa48))

## [0.15.1](https://github.com/i-am-logger/mynixos/compare/mynixos-v0.15.0...mynixos-v0.15.1) (2026-08-04)


### Bug Fixes

* **wezterm:** repair line editing, window sizing and transparency on macOS ([#139](https://github.com/i-am-logger/mynixos/issues/139)) ([a623c0b](https://github.com/i-am-logger/mynixos/commit/a623c0b25f3bc43bb66a346743a613e84642157c))
...
* **deps:** vogix 0.8.0 + nixpkgs deprecation fixes ([#127](https://github.com/i-am-logger/mynixos/issues/127)) ([d4e7f32](https://github.com/i-am-logger/mynixos/commit/d4e7f32b820144330fab8b13d27d9c9d4d8a3365))
...
* mkApp DSL helper, evidence-based type-safety, dead-code removal, and a booting VM test ([#119](https://github.com/i-am-logger/mynixos/issues/119)) ([633add7](https://github.com/i-am-logger/mynixos/commit/633add78968d1f071de5cba2a5a934ad6b7c66d5))
...
* **streaming:** add cudatoolkit to advanced-scene-switcher on NVIDIA systems ([867df22](https://github.com/i-am-logger/mynixos/commit/867df22a4d4952f9f49523f1b5b40156d0e4dc22))
